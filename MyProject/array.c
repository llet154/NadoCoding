...
//	//}
//
//	////배열의 크기에 변수는 올 수 없음 무조건 상수 값이 와야함
//	//int size = 10;
//	//int arr[size]; //오류가 발생
//
...
//
//	//float arr_f[5] = { 1.0, 2.0, 3.0 }; //3번째 값부터는 자동으로 '0.00'으로 초기화 됨
//	//for (int i = 0; i < 5; i++)
//	//{
//	//	printf("%.2f\n", arr_f[i]);
//	//}
...
//	//char str[7] = "coding"; //[c][o][d][i][n][g][\0] <-처럼 한칸의 여유를 둬야함
//	//printf("%s\n", str);
//
//	/*char str[] = "coding";*/
//	//printf("%s\n", str);
//	//printf("%d\n", sizeof(str)); //한칸의 여유를 두고 7이 출력됨
//
...
//	//char kor[] = "나도코딩";
//	//printf("%s\n", kor);
//	//printf("%d\n", sizeof(kor)); //한글은 1글자 2바이트라서 사이즈가 한칸여유두고 9가 출력됨
//	//영어는 1글자 : 1 byte
//	//한글은 1글자 : 2 byte
//	// 한 글
//	// En Gl
...
//		printf("%c\n", c_array[i]);
//	}*/
//	//for (int i = 0; i < sizeof(c_array); i++) //뒤에 남는 공간은 null문자로 입력
//	//{
